...
export { isArray, isEmptyArray, isNotEmptyArray, arr, isBoolean, isTrue, isFalse, bool, isDate, removeSymbols, toFixed, isAsyncFunction, isSyncFunction, isFunction, is, isNil, isPrimitive, isEqual, isOneOf, getOneOf, getFirstBy, isMap, isWeakMap, map, weakmap, isNumber, isPositiveInfinity, isPositiveNumber, isNegativeInfinity, isNegativeNumber, numInRange, num, isObject, obj, isNodeJS, isBrowser, isElectron, isTauri, isPromise, isRegExp, isSet, isWeakSet, set, weakset, isString, isEmptyString, isNotEmptyString, str, jsonize, dejsonize };
